...
public class content_day_time_table extends AppCompatActivity {
    ...
    PendingIntent vibrate_pendent_intent;
    Intent vibrate_intent;
    AlarmManager vibrate_alarm_manager;
    ...
    public void submitInputDetails(View view)
    {
        ...
        vibrate_intent=new Intent(getApplicationContext(),VibrateMode.class);
        vibrate_intent.setAction(Long.toString(System.currentTimeMillis()));

        vibrate_pendent_intent = PendingIntent.getBroadcast(getApplicationContext(), getAlarmId(getApplicationContext()), vibrate_intent, PendingIntent.FLAG_UPDATE_CURRENT);
        vibrate_alarm_manager.setRepeating(AlarmManager.RTC_WAKEUP,time_in_millis-5*60*1000, AlarmManager.INTERVAL_DAY*7,vibrate_pendent_intent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder inputAlertDialogueBuilder = new AlertDialog.Builder(content_day_time_table.this);
        ...
        vibrate_alarm_manager = (AlarmManager) this.getSystemService(Context.ALARM_SERVICE);
